...
/**
 * Devuelve las clases de tipografía combinando tamaño, variante y clases extra.
 */
const getTypography = (size?: Size, variant?: Variant, className?: string): string => {
	return cn(typography({ size, variant, className }));
};

/**
 * Devuelve las clases de tipografía para un tamaño específico.
 */
const getTypographySize = (size?: Size, className?: string): string =>
	getTypography(size, undefined, className);

/**
 * Devuelve las clases de tipografía para una variante específica.
 */
const getTypographyVariant = (variant?: Variant, className?: string): string =>
